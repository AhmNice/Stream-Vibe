...
const PricingCard = ({type, description, price,billing_circle}) => {
  return (
    <div className='pricingCard p-6 rounded-md text-white flex flex-col gap-6 w-full'>
        ...
        <p className='text-gray-500'><span className='Manrope-SemiBold text-2xl text-white'>{price}</span>/{billing_circle}</p>
